            ...
            <div className="max-w-6xl 2xl:max-w-8xl 3xl:max-w-[100rem] 4xl:max-w-[120rem] w-full py-6 2xl:py-8 3xl:py-12 4xl:py-16 flex flex-col gap-8 lg:gap-12 2xl:gap-16 3xl:gap-20 4xl:gap-24">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 lg:gap-12 2xl:gap-16 3xl:gap-24 4xl:gap-32 px-6 sm:px-8 lg:px-12 2xl:px-16 3xl:px-20 4xl:px-24">
                <div className="flex-shrink-0">
                  <img src="./feature1.gif" alt="Open & Framework-Agnostic" className="w-40 h-28 sm:w-48 sm:h-32 md:w-56 md:h-36 lg:w-64 lg:h-40 2xl:w-[28rem] 2xl:h-64 3xl:w-[36rem] 3xl:h-72 4xl:w-[44rem] 4xl:h-88 object-contain" loading="lazy" />
                </div>
              ...
              <div className="flex flex-col md:flex-row-reverse items-center gap-6 md:gap-8 lg:gap-12 2xl:gap-16 3xl:gap-24 4xl:gap-32 px-6 sm:px-8 lg:px-12 2xl:px-16 3xl:px-20 4xl:px-24">
                <div className="flex-shrink-0">
                  <img src="./feature2.gif" alt="AI-Powered, Actionable Feedback" className="w-40 h-28 sm:w-48 sm:h-32 md:w-56 md:h-36 lg:w-64 lg:h-40 2xl:w-[28rem] 2xl:h-64 3xl:w-[36rem] 3xl:h-72 4xl:w-[44rem] 4xl:h-88 object-contain" loading="lazy" />
                </div>
                <div className="flex-1 text-center md:text-left min-w-0">
                  <div className="flex items-center justify-center md:justify-start gap-2 2xl:gap-3 3xl:gap-4 mb-1 2xl:mb-2 3xl:mb-3 4xl:mb-4">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 lg:gap-12 2xl:gap-16 3xl:gap-24 4xl:gap-32 px-6 sm:px-8 lg:px-12 2xl:px-16 3xl:px-20 4xl:px-24">
                <div className="flex-shrink-0">
                  <img src="./feature3.gif" alt="Guided Recommendations & Iteration" className="w-40 h-28 sm:w-48 sm:h-32 md:w-56 md:h-36 lg:w-64 lg:h-40 2xl:w-[28rem] 2xl:h-64 3xl:w-[36rem] 3xl:h-72 4xl:w-[44rem] 4xl:h-88 object-contain" loading='lazy' />
                </div>
                <div className="flex-1 text-center md:text-left min-w-0">
                  <div className="flex items-center justify-center md:justify-start gap-2 2xl:gap-3 3xl:gap-4 mb-1 2xl:mb-2 3xl:mb-3 4xl:mb-4">

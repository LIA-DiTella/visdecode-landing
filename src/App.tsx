      ...
      <div className="relative max-w-xl mx-auto pt-6 sm:pt-8 lg:pt-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center z-10">
        <div className="relative flex flex-col items-center gap-2 sm:gap-4 w-full">
          ...
          <motion.img
            ...
            alt="Logo"
            className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mb-4 sm:mb-6"
          ...
          <motion.form
            className="flex flex-col sm:flex-row gap-3 mb-8 sm:mb-12 w-full justify-center px-4"
        ...
        <div className="relative flex flex-col items-center gap-2 sm:gap-4 w-full mb-12">
          ...
          <div className="w-full flex flex-row items-center justify-center gap-0 sm:gap-2 lg:gap-4 px-2 sm:px-4 lg:px-8 text-black">
            {/* Step 1 */}
        ...
        <div className="relative flex flex-col items-center gap-2 sm:gap-4 w-full">
          ...
          <div className="w-full flex flex-col items-center lg:px-8 mb-12">
            <div className="max-w-4xl w-full py-8 flex flex-col gap-10">
              {/* Feature 1 */}
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                <img src="./public/background-wave.svg" alt="Open & Framework-Agnostic" className="w-40 h-24 object-contain" />
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                ...
                <img src="./public/screenshot-placeholder.png" alt="AI-Powered, Actionable Feedback" className="w-40 h-24 object-contain" />
              </div>
              {/* Feature 3 */}
              <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                <img src="./public/screenshot-placeholder.png" alt="Guided Recommendations & Iteration" className="w-40 h-24 object-contain" />
                <div className="flex-1 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
